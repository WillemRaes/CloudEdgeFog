...
--------------------------------------
This documentation is written in the context of the TETRA project AISiBoCo - funded by the flemish agency for innovation and entrepreneurship (VLAIO) - on the topic of deploying Machine Learning algorithms on single board computers.
